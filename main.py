...
async def _enter_app(from_user, answer_msg=None, edit_call=None):
    ...
    if active:
        ...
        cta = 'Начать можно бесплатно. Жми кнопку ниже 👇'
    ...
    text = (
        ...
        f'<b>Что внутри</b>\n'
        f'🌐 <b>Прокси</b> — аккаунты работают стабильно и безопасно\n'
        f'👤 <b>Аккаунты</b> — подключение по номеру или импортом сессии\n'
        f'🎯 <b>Сбор базы</b> — из любых открытых чатов и каналов\n'
        f'📨 <b>Рассылка</b> — AI-тексты, spintax, темп живого человека\n\n'
        f'{status_ln}\n'
        f'{cta}'
    )
    if edit_call:
